...
/*
 * g++ -o scan_wasm_file_unchecked scan_wasm_file_unchecked.cc -std=c++23 -Ofast -s -flto -march=native -fno-exceptions -fno-rtti -fno-unwind-tables -fno-asynchronous-unwind-tables -fno-ident -mprefetchi -I../../third-parties/fast_io/include -I../../src/utils
 */
