...
namespace fast_io::containers
{
    ...
    public:
        ...
        inline constexpr const_iterator begin() const noexcept { return ptr; }

        inline constexpr const_iterator cbegin() const noexcept { return ptr; }

        inline constexpr const_iterator end() const noexcept { return ptr + n; }

        inline constexpr const_iterator cend() const noexcept { return ptr + n; }

        inline constexpr const_reverse_iterator rbegin() const noexcept { return const_reverse_iterator(ptr + n); }

        inline constexpr const_reverse_iterator crbegin() const noexcept { return const_reverse_iterator(ptr + n); }

        inline constexpr const_reverse_iterator rend() const noexcept { return const_reverse_iterator(ptr); }

        inline constexpr const_reverse_iterator crend() const noexcept { return const_reverse_iterator(ptr); }
        ...
        {
            if(n <= idx) [[unlikely]] { ::fast_io::fast_terminate(); }
            return ptr[idx];
        }
        ...
        inline constexpr const_reference
            back() const noexcept
        {
            if(n == 0) [[unlikely]] { ::fast_io::fast_terminate(); }
