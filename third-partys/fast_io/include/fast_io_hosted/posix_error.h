...
inline constexpr basic_io_scatter_t<char_type> status_io_print_forward(io_alias_type_t<char_type>,
																	   ::fast_io::freestanding::errc perr) noexcept
{
...
inline constexpr bool equivalent_define(error_type_t<::fast_io::freestanding::errc>, ::fast_io::error e,
										::fast_io::freestanding::errc p)
{
	return ::fast_io::details::posix_code_equivalent_impl(e.domain, e.code, static_cast<int>(p));
}

inline constexpr ::fast_io::freestanding::errc to_code_define(error_type_t<::fast_io::freestanding::errc>,
															  error e) noexcept
{
