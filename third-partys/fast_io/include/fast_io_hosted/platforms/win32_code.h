...
inline ::std::size_t print_reserve_define_win32_error_ntw_impl(char16_t *ptr, ::std::uint_least32_t ec) noexcept
{
	...
	return ::fast_io::win32::FormatMessageW(0x00000200 | 0x00001000, nullptr, ec, (1 << 10), ptr, char16_buffer_size,
											nullptr);
}
...
#endif
				= char16_t *;
			::std::size_t sz{print_reserve_define_win32_error_ntw_impl(
				reinterpret_cast<char_type_may_alias_ptr>(buffer.data()), ec)};
...
template <::std::integral char_type>
inline constexpr char_type *print_reserve_define(io_reserve_type_t<char_type, win32_code>, char_type *iter,
												 win32_code e) noexcept
{
