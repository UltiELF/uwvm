...
namespace uwvm::parameter
{
    ...
    inline constexpr ::uwvm::cmdline::parameter enable_reference_types{ // default
        ...
        .describe{::fast_io::u8string_view{
            u8"Enable reference types for WebAssembly (https://github.com/WebAssembly/reference-types/blob/master/proposals/reference-types/Overview.md). Usage: [--enable-reference-types|-Eref]"}},
