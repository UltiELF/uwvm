...
namespace uwvm::parameter
{
    namespace details
    {
        inline constexpr ::fast_io::string_view enable_custom_page_sizes_alias{"-Ecps"};
    }  // namespace details
    ...
    inline constexpr ::uwvm::cmdline::parameter enable_custom_page_sizes{
        ...
        .describe{::fast_io::u8string_view{
            u8"Enable custom page sizes for WebAssembly (https://github.com/WebAssembly/custom-page-sizes/blob/main/proposals/custom-page-sizes/Overview.md). Usage: [--enable-custom-page-sizes|-Ecps]"}},
