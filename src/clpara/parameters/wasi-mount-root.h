...
namespace uwvm::parameter
{
    namespace details
    {
        ...
        inline constexpr ::fast_io::string_view wasi_mount_root_alias{"-Wmr"};
    ...
    inline constexpr ::uwvm::cmdline::parameter wasi_mount_root{
        ...
        .describe{::fast_io::u8string_view{u8"Mount the current folder to the root directory of WASI. Usage: [--wasi-mount-root|-Wmr] <path>"}},
