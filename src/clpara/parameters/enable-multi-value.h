...
namespace uwvm::parameter
{
    namespace details
    {
        ...
        inline constexpr ::fast_io::string_view enable_multi_value_alias{"-Emv"};
    }  // namespace details

    inline constexpr ::uwvm::cmdline::parameter enable_multi_value{
        .name{::fast_io::string_view{"--enable-multi-value"}},
        .describe{
            ::fast_io::u8string_view{u8"Enable multi-value for WebAssembly (https://github.com/WebAssembly/multi-value). Usage: [--enable-multi-value|-Emv]"}},
