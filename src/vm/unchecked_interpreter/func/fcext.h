...
#endif
        inline void
            memory_copy(::std::byte const* code, ::uwvm::vm::unchecked_interpreter::operator_t const* curr,  ::uwvm::vm::unchecked_interpreter::stack_t* local_begin,::uwvm::vm::unchecked_interpreter::stack_t* stack_curr) noexcept
        {
            ...
            auto const& memory{::uwvm::vm::unchecked_interpreter::memories.front_unchecked()};
...
#endif
        inline void
            memory_fill(::std::byte const* code, ::uwvm::vm::unchecked_interpreter::operator_t const* curr,  ::uwvm::vm::unchecked_interpreter::stack_t* local_begin,::uwvm::vm::unchecked_interpreter::stack_t* stack_curr) noexcept
        {
