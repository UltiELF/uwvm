...
{
    template <>
    struct is_trivially_relocatable<::uwvm::vm::unchecked_interpreter::global_storage>
    {
        inline static constexpr bool value = true;
    };

    template <>
    struct is_zero_default_constructible<::uwvm::vm::unchecked_interpreter::global_storage>
    {
        inline static constexpr bool value = true;
    };
